    ...
    <section class="py-24 relative">
        <div class="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
            <div class="w-full justify-start items-center gap-8 grid lg:grid-cols-2 grid-cols-1">
                ...
                <img class="lg:mx-0 mx-auto h-full rounded-3xl object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSUHqC_JDXs9qoN4_-coX5TJxb1ZB0tFVzuOA&s" alt="about Us image" />
            </div>
        </div>
    </section>
  )
